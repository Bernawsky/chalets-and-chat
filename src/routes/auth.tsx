  ...
  head: () => ({
    meta: [
      { title: "Entrar — Painel de Pedidos Quitutes" },
      {
        name: "description",
        content:
          "Área restrita: entre com sua conta autorizada para acessar as métricas e administrar os pedidos das cestas de café da manhã.",
      },
      { property: "og:title", content: "Entrar — Painel de Pedidos Quitutes" },
      {
        property: "og:description",
        content: "Acesso restrito ao painel de métricas e administração de pedidos.",
      },
    ],
  }),
  component: AuthPage,
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-border bg-card p-6 shadow-sm">
          ...
          <p className="mt-4 text-xs text-muted-foreground">
            O acesso é liberado apenas para contas autorizadas pela administração.
          </p>
        </div>
      </div>
    </div>
